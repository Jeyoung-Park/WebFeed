...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView TextView_title, TextView_address, TextView_ChangeDetection, TextView_recyclerview_delete_item, TextView_keyword;
        public MyViewHolder(View itemView) {
            ...
            TextView_keyword=itemView.findViewById(R.id.TextView_rvitem_keyword);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.TextView_keyword.setText("키워드: "+rvList.get(position).getKeyword());
